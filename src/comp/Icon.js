    ...
    return (
        <>
            <div class="content-title">
                ...
                <progress id="progress3" value="55" min="0" max="100"></progress><br/>
                <img src="/image/java.svg" alt="Java" class="icon" />
                <progress id="progress3" value="45" min="0" max="100"></progress><br/>
                <img src="/image/sql.svg" alt="sql" class="icon" />
                <progress id="progress" value="30" min="0" max="100"></progress><br/>
                <img src="/image/git.svg" alt="git" class="icon" />
                <progress id="progress" value="20" min="0" max="100"></progress><br/>
                <img src="/image/firebase.svg" alt="firebase" class="icon" />
                <progress id="progress" value="10" min="0" max="100"></progress><br/>
